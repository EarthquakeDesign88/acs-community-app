...
class BodyFacility extends StatelessWidget {
  ...
  final FacilityController _facilityController = Get.put(FacilityController());
    ...
    return TabBarView(children: [
      ListView.builder(
        ...
        itemBuilder: (context, index) {
          final latestFacilityId = _facilityController.facilityLists.last.id;
          ...
          return Column(
            children: [
              ...
              Row(
                ...
                children: [
                  FacilityCard(
                    ...
                    onTap: () {
                        Get.toNamed(RouteHelper.getFacilityBooking(facility1.id));
                    },
                  ),
                  ...
                  if (facility2 != null)
                    FacilityCard(
                      ...
                      onTap: () {
                          Get.toNamed(RouteHelper.getFacilityBooking(facility2.id));
                      },
                    )
                  else 
              ...
              if (latestFacilityId == facility1.id || (facility2 != null && latestFacilityId == facility2.id))
                SizedBox(height: Dimensions.height10)
            ],
          );
        },
